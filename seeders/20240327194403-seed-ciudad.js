    ...
    await queryInterface.bulkInsert('Ciudads', [
      {
        ...
        Direccion: "Avenida tres pasos al frente nro 5550",
      ...
      },
      {
        Departamento: "Oruro",
        Municipio: "Oruro",
        Direccion: "Av circunbalacion nro 123",
      ...
      },
      {
        ...
        Direccion: "Avenida Calacoto Nro 512",
      ...
      },
      {
        ...
        Direccion: "Avenida Blanco Galindo Nro 345",
